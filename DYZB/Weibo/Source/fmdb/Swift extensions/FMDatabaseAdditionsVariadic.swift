...
extension FMDatabase {
    ...
    func stringForQuery(sql: String, _ values: AnyObject...) -> String! {
        return valueForQuery(sql: sql, values: values as NSArray) { $0.string(forColumnIndex: 0) }
    }
    ...
    func intForQuery(sql: String, _ values: AnyObject...) -> Int32! {
        return valueForQuery(sql: sql, values: values as NSArray) { $0.int(forColumnIndex: 0) }
    }
    ...
    func longForQuery(sql: String, _ values: AnyObject...) -> Int! {
        return valueForQuery(sql: sql, values: values as NSArray) { $0.long(forColumnIndex: 0) }
    }
    ...
    func boolForQuery(sql: String, _ values: AnyObject...) -> Bool! {
        return valueForQuery(sql: sql, values: values as NSArray) { $0.bool(forColumnIndex: 0) }
    }
    ...
    func doubleForQuery(sql: String, _ values: AnyObject...) -> Double! {
        return valueForQuery(sql: sql, values: values as NSArray) { $0.double(forColumnIndex: 0) }
    }
    ...
    func dateForQuery(sql: String, _ values: AnyObject...) -> NSDate?{
       // return valueForQuery(sql: sql, values: values as NSArray) { $0.date(forColumnIndex: 0) }
        return nil
    }
    ...
    func dataForQuery(sql: String, _ values: AnyObject...) -> NSData? {
       // return valueForQuery(sql: sql, values: values as NSArray) { $0.data(forColumnIndex:0) }// $0.dateForColumnIndex(0)
        return nil
    }
}
